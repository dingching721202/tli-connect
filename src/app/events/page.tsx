...
const EventsPage: React.FC = () => {
  ...
  const events: Event[] = [
    ...
    },
    {
      ...
      organizer: 'Teacher Training Institute',
      duration: '4 hours',
      participants: 20,
      maxParticipants: 30,
      rating: 4.9,
      price: 1200,
      schedule: '2025-09-05 09:00',
      location: 'Education Center',
      description: 'Advanced workshop on modern Chinese teaching methodologies and classroom management techniques.',
      level: 'advanced',
      category: '師培',
      tags: ['teaching', 'methodology', 'professional'],
      features: ['Advanced Techniques', 'Hands-on Practice', 'Certification'],
      status: 'upcoming'
    },
    {
      id: 5,
