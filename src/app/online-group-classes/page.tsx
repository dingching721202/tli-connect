...
const OnlineGroupClassesPage: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'teacher-training', name: '師培', count: onlineGroupClasses.filter(c => c.category === 'teacher-training').length }
  ];
...
export default OnlineGroupClassesPage;